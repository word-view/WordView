  ...
  return (
    <ScrollView style={!desktop && { backgroundColor: '#2C2831' }}>
      <ContentHolder title='Criar uma conta'>
        <AuthInput label='Email' errorText={'emailErrorText'} erroring={false} onChangeText={() => {}} />
        <AuthInput label='Nome de Usuário' errorText={'usernameErrorText'} erroring={false} onChangeText={() => {}} />
        <AuthInput
          label='Senha'
          secure={true}
        ...
        <RNPButton mode='text' onPress={() => props.navigation.navigate('LanguagePicker')} style={{ marginTop: hp(1) }}>
